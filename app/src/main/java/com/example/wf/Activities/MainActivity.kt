package com.example.wf.Activities
...
import com.example.wf.Models.WeatherModel
import com.example.wf.R
import com.example.wf.Utilites.APIutilities
import com.example.wf.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private val apiKey="9f5653264657cf1799f1fa37efd5b270"
        ...
        binding.apply {
            ...
            when (id) {
                ...
                in 200..232 -> {
                    ...
                    weatherImage.setImageResource(R.drawable.ic_storm_weather)
                ...
                in 300..321 -> {
                    ...
                    weatherImage.setImageResource(R.drawable.ic_few_clouds)
                ...
                in 500..531 -> {
                    ...
                    weatherImage.setImageResource(R.drawable.ic_rainy_weather)
                ...
                in 701..781 -> {
                    ...
                    weatherImage.setImageResource(R.drawable.ic_broken_clouds)
                ...
                800 -> {
                    ...
                    weatherImage.setImageResource(R.drawable.ic_clear_day)
